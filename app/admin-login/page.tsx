...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Try to login as admin - the system will check if the user has admin privileges
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-red-50 to-orange-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">NAPOLCOM Administrative Access</p>
        </div>
        ...
        <Card className="card-hover shadow-xl">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Submit Button */}
              <Button type="submit" className="w-full h-12 text-base font-medium bg-red-600 hover:bg-red-700" disabled={isLoading}>
                {isLoading ? (
